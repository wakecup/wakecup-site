...
const i18n: i18nProps = {
  ...
  dna: 'Our DNA',
  dnaDescription: 'MORE PURPOSE. LESS PROMISES',
  mission: 'Our Mission',
  missionDescription: `Founded since 2017, our mission has been to engage and connect brands to the right partners in order to deliver a customized and engineered approach to growing businesses that combines marketing strategy, social media, communications & PR and website development.\nFrom awareness to traffic generation to prospect education and finally closing the deal; our engagements are end-to-end solutions for growing businesses.`,
  services: 'Services',
  ...
  serviceDescription2:
    'Meeting the expectations of today’s complex, hyper-connected digital natives is essential to your success. We prototype high converting Websites, Web Apps, Interfaces, and Digital products by designing elegant UI UX and building web pages that solve business and growth challenges. Our process involves more than just pretty pixels, instead we design intuitive digital interfaces based on human behavior. We bring complex Websites, e-Commerce, and Apps to life in HTML, CSS, and Javascript.',
