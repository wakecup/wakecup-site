...
const i18n: i18nProps = {
  ...
  mission: 'Our Mission',
  missionDescription: `Founded since 2017, our mission has been to engage and connect brands to the right partners in order to deliver a customized and engineered approach to growing businesses that combines marketing strategy, social media, communications & PR and software development.\nFrom awareness to traffic generation to prospect education and finally closing the deal; our engagements are end-to-end solutions for growing businesses.`,
  services: 'Services',
